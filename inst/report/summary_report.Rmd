...
if(grepl("\\.zip$", params$outputs)) {
  ...
  outputs <- naomi.zaf::read_output_package(output_zip)
...
indicators <- naomi.zaf::add_output_labels(outputs) 
indicators_geom <- naomi.zaf::add_output_labels(outputs, geometry = TRUE)
...
#-------------------------------------------------------------------------------
p1 <- naomi.zaf::map_outputs(indicators_geom, 
                         indicator = "plhiv",
                         age = "Y015_999", 
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p2 <- naomi.zaf::map_outputs(indicators_geom, 
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p3 <- naomi.zaf::map_outputs(indicators_geom, 
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p4 <- naomi.zaf::map_outputs(indicators_geom, 
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p5 <- naomi.zaf::map_outputs(indicators_geom, 
...
# # By lowest area_level
#-------------------------------------------------------------------------------
p6 <- naomi.zaf::map_outputs(indicators_geom, 
                         indicator = "incidence",
                         age = "Y015_049", 
                         sex_disag = "both", 
                         calendar_quarter = options$calendar_quarter_t2,
